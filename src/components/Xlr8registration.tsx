...
export default function XLR8Registration() {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.leaderRollNumber.trim()) newErrors.leaderRollNumber = 'Roll number is required';
    ...
    if (!formData.leaderMentorName.trim()) newErrors.leaderMentorName = 'ISMP Mentor Name is required';
    if (!formData.leaderMentorPhone.trim()) {
      newErrors.leaderMentorPhone = 'ISMP Mentor Phone Number is required';
    } else if (!phoneRegex.test(formData.leaderMentorPhone.trim())) {
      newErrors.leaderMentorPhone = 'Enter a valid phone number';
    }

    // 3. Participant 2 Validations
    if (!formData.p2Name.trim()) newErrors.p2Name = 'Name is required';
    if (!formData.p2RollNumber.trim()) newErrors.p2RollNumber = 'Roll number is required';
    ...
    if (!formData.p2MentorName.trim()) newErrors.p2MentorName = 'ISMP Mentor Name is required';
    if (!formData.p2MentorPhone.trim()) {
      newErrors.p2MentorPhone = 'ISMP Mentor Phone Number is required';
    } else if (!phoneRegex.test(formData.p2MentorPhone.trim())) {
      newErrors.p2MentorPhone = 'Enter a valid phone number';
    }

    // 4. Participant 3 Validations
    if (!formData.p3Name.trim()) newErrors.p3Name = 'Name is required';
    if (!formData.p3RollNumber.trim()) newErrors.p3RollNumber = 'Roll number is required';
    ...
    if (!formData.p3MentorName.trim()) newErrors.p3MentorName = 'ISMP Mentor Name is required';
    if (!formData.p3MentorPhone.trim()) {
      newErrors.p3MentorPhone = 'ISMP Mentor Phone Number is required';
    } else if (!phoneRegex.test(formData.p3MentorPhone.trim())) {
      newErrors.p3MentorPhone = 'Enter a valid phone number';
    }

    // 5. Participant 4 Validations
    if (!formData.p4Name.trim()) newErrors.p4Name = 'Name is required';
    if (!formData.p4RollNumber.trim()) newErrors.p4RollNumber = 'Roll number is required';
    ...
    if (!formData.p4MentorName.trim()) newErrors.p4MentorName = 'ISMP Mentor Name is required';
    if (!formData.p4MentorPhone.trim()) {
      newErrors.p4MentorPhone = 'ISMP Mentor Phone Number is required';
    } else if (!phoneRegex.test(formData.p4MentorPhone.trim())) {
      newErrors.p4MentorPhone = 'Enter a valid phone number';
    }

    // 6. Drive Links Validations
    if (!formData.teamSelfieLink.trim()) {
      ...
      newErrors.teamSelfieLink = 'Must be a valid URL starting with http:// or https://';
    }

    if (!formData.paymentScreenshotLink.trim()) {
      newErrors.paymentScreenshotLink = 'Payment Screenshot link is required';
    } else if (!formData.paymentScreenshotLink.startsWith('http')) {
      newErrors.paymentScreenshotLink = 'Must be a valid URL starting with http:// or https://';
    }
  ...
  const getSectionStatus = (fields: (keyof FormData)[]) => {
    const filledCount = fields.filter((f) => formData[f].trim().length > 0).length;
  ...
  const sections = [
    { id: 'sec-team', label: 'Team Details', fields: ['teamName'] as (keyof FormData)[] },
    { id: 'sec-leader', label: 'Leader', fields: ['leaderName', 'leaderRollNumber', 'leaderPhone', 'leaderEmail', 'leaderMentorName', 'leaderMentorPhone'] as (keyof FormData)[] },
    { id: 'sec-p2', label: 'Participant 2', fields: ['p2Name', 'p2RollNumber', 'p2Phone', 'p2MentorName', 'p2MentorPhone'] as (keyof FormData)[] },
    { id: 'sec-p3', label: 'Participant 3', fields: ['p3Name', 'p3RollNumber', 'p3Phone', 'p3MentorName', 'p3MentorPhone'] as (keyof FormData)[] },
    { id: 'sec-p4', label: 'Participant 4', fields: ['p4Name', 'p4RollNumber', 'p4Phone', 'p4MentorName', 'p4MentorPhone'] as (keyof FormData)[] },
    { id: 'sec-sub', label: 'Submission', fields: ['teamSelfieLink', 'paymentScreenshotLink'] as (keyof FormData)[] },
  ];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-28">
        ...
        {submitted ? (
          <div className="max-w-2xl mx-auto bg-blue-900/20 border border-blue-500/30 rounded-2xl p-8 backdrop-blur-md text-center shadow-[0_0_35px_rgba(59,130,246,0.2)] animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <h2 className="text-2xl font-bold font-heading text-white mb-2">Registration Submitted!</h2>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  {errors.leaderName && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.leaderName}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.leaderRollNumber && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.leaderRollNumber}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.leaderPhone && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.leaderPhone}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.leaderEmail && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.leaderEmail}
                    </p>
                  )}
                </div>
                ...
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-gray-300 mb-2">
                    ISMP Mentor Name <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                    ...
                    className={`w-full rounded-xl bg-gray-900/60 border ${
                      errors.leaderMentorName ? 'border-red-500' : 'border-white/10'
                    } text-white placeholder-gray-500 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-all outline-none`}
                  />
                  {errors.leaderMentorName && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.leaderMentorName}
                    </p>
                  )}
                </div>
                ...
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-gray-300 mb-2">
                    ISMP Mentor Phone Number <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="tel"
                  ...
                  />
                  {errors.leaderMentorPhone && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.leaderMentorPhone}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Full Name"
                    className={`w-full rounded-xl bg-gray-900/60 border ${
                      errors.p2Name ? 'border-red-500' : 'border-white/10'
                    } text-white placeholder-gray-500 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-all outline-none`}
                  />
                  {errors.p2Name && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p2Name}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.p2RollNumber && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p2RollNumber}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.p2Phone && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p2Phone}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Mentor Full Name"
                    className={`w-full rounded-xl bg-gray-900/60 border ${
                      errors.p2MentorName ? 'border-red-500' : 'border-white/10'
                    } text-white placeholder-gray-500 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-all outline-none`}
                  />
                  {errors.p2MentorName && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p2MentorName}
                    </p>
                  )}
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  />
                  {errors.p2MentorPhone && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p2MentorPhone}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Full Name"
                    className={`w-full rounded-xl bg-gray-900/60 border ${
                      errors.p3Name ? 'border-red-500' : 'border-white/10'
                    } text-white placeholder-gray-500 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-all outline-none`}
                  />
                  {errors.p3Name && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p3Name}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.p3RollNumber && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p3RollNumber}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.p3Phone && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p3Phone}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Mentor Full Name"
                    className={`w-full rounded-xl bg-gray-900/60 border ${
                      errors.p3MentorName ? 'border-red-500' : 'border-white/10'
                    } text-white placeholder-gray-500 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-all outline-none`}
                  />
                  {errors.p3MentorName && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p3MentorName}
                    </p>
                  )}
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  />
                  {errors.p3MentorPhone && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p3MentorPhone}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Full Name"
                    className={`w-full rounded-xl bg-gray-900/60 border ${
                      errors.p4Name ? 'border-red-500' : 'border-white/10'
                    } text-white placeholder-gray-500 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-all outline-none`}
                  />
                  {errors.p4Name && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p4Name}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.p4RollNumber && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p4RollNumber}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.p4Phone && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p4Phone}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Mentor Full Name"
                    className={`w-full rounded-xl bg-gray-900/60 border ${
                      errors.p4MentorName ? 'border-red-500' : 'border-white/10'
                    } text-white placeholder-gray-500 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-all outline-none`}
                  />
                  {errors.p4MentorName && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p4MentorName}
                    </p>
                  )}
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  />
                  {errors.p4MentorPhone && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.p4MentorPhone}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-gray-300 mb-2 flex items-center gap-1.5">
                    ...
                    Team Selfie Google Drive Link <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="url"
                    name="teamSelfieLink"
                  ...
                  {errors.teamSelfieLink && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.teamSelfieLink}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.paymentScreenshotLink && (
                    <p className="mt-1.5 text-xs text-red-400 flex items-center gap-1">
                      <AlertCircle className="w-3.5 h-3.5" /> {errors.paymentScreenshotLink}
                    </p>
                  )}
                </div>
              </div>
